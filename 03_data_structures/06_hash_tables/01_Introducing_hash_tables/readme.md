...
- [📑 **Introducing Hash Tables**](#-introducing-hash-tables)
  - [🔑 Why Hash Tables?](#-why-hash-tables)
  - [🖼️ Visual Representation](#️-visual-representation)
  - [📘 Dictionaries (Real-World Example)](#-dictionaries-real-world-example)
    - [🐍 Python Example](#-python-example)
    - [📤 Output](#-output)
  - [⚡ Efficiency of Hash Tables](#-efficiency-of-hash-tables)
- [🔑 **Hashing Functions**](#-hashing-functions)
  - [📝 Example: Hashing Strings](#-example-hashing-strings)
    - [📌 `ord()` Function in Python](#-ord-function-in-python)
    - [🧮 Simple Hash with `sum(map(ord, s))`](#-simple-hash-with-summapord-s)
    - [📊 Visual Representation](#-visual-representation)
      - [Figure 8.2](#figure-82)
  - [⚠️ Problem: Collisions](#️-problem-collisions)
      - [Figure 8.3](#figure-83)
  - [🎯 Perfect Hashing Functions](#-perfect-hashing-functions)
  - [🚀 Improved Hashing Strategy](#-improved-hashing-strategy)
    - [📊 Visual Representation](#-visual-representation-1)
      - [Figure 8.4](#figure-84)
  - [🐍 Python Implementation](#-python-implementation)
    - [🔎 Testing the Function](#-testing-the-function)
    - [⚠️ Still Not Perfect](#️-still-not-perfect)
- [🔑 **Resolving Collisions** in Hash Tables](#-resolving-collisions-in-hash-tables)
  - [📝 Example Hash Function](#-example-hash-function)
  - [📊 Sample Hash Table (Figure 8.5)](#-sample-hash-table-figure-85)
  - [🚨 Collision Example (Figure 8.6)](#-collision-example-figure-86)
  - [⚒️ Collision Resolution Strategy](#️-collision-resolution-strategy)
- [🔑 Open Addressing in Hash Tables](#-open-addressing-in-hash-tables)
  - [⚒️ Approaches of Open Addressing](#️-approaches-of-open-addressing)
  - [📌 Linear Probing](#-linear-probing)
    - [🖼 Example of Linear Probing](#-example-of-linear-probing)
  - [⚠️ Drawback of Linear Probing](#️-drawback-of-linear-probing)
- [🛠 Implementing Hash Tables in Python](#-implementing-hash-tables-in-python)
  - [📦 Step 1: Hash Item Class](#-step-1-hash-item-class)
  - [📦 Step 2: Hash Table Class](#-step-2-hash-table-class)
  - [📦 Step 3: Hash Function](#-step-3-hash-function)
  - [📦 Storing Elements in a Hash Table](#-storing-elements-in-a-hash-table)
  - [🔑 Step 1: Updating `HashItem` Class](#-step-1-updating-hashitem-class)
  - [🔑 Step 2: Implementing `put()` Function](#-step-2-implementing-put-function)
  - [🌀 Step-by-Step Explanation](#-step-by-step-explanation)
  - [📌 Key Notes](#-key-notes)
  - [📈 **Growing a Hash Table**](#-growing-a-hash-table)
  - [📊 Load Factor (How Full the Table Is)](#-load-factor-how-full-the-table-is)
    - [🔎 Observations:](#-observations)
  - [🌀 Why Grow the Table?](#-why-grow-the-table)
  - [🛠 Implementation Details](#-implementation-details)
    - [Step 1: Extend the `HashTable` Class](#step-1-extend-the-hashtable-class)
    - [Step 2: `check_growth()` Method](#step-2-check_growth-method)
    - [Step 3: `growth()` Method](#step-3-growth-method)
    - [🖥 Step-by-Step Explanation:](#-step-by-step-explanation-1)
  - [📌 Example: Growing the Hash Table](#-example-growing-the-hash-table)
  - [🖥 Output](#-output-1)
    - [🔎 Explanation:](#-explanation)
- [📦 **Retrieving Elements from the Hash Table**](#-retrieving-elements-from-the-hash-table)
  - [🔑 How Retrieval Works](#-how-retrieval-works)
  - [📊 Example (Figure 8.8)](#-example-figure-88)
  - [🖥️ Code Implementation – `get()` Method](#️-code-implementation--get-method)
    - [🔎 Step-by-Step Explanation](#-step-by-step-explanation-2)
  - [🧪 Testing the Hash Table](#-testing-the-hash-table)
  - [📤 Output](#-output-2)
- [📚 Implementing a Hash Table as a Dictionary](#-implementing-a-hash-table-as-a-dictionary)
...
- [🔄 **Quadratic Probing in Hash Tables**](#-quadratic-probing-in-hash-tables)
  - [🧮 Formula](#-formula)
  - [🖼️ Visual Example](#️-visual-example)
    - [Step 1️⃣ – Insert 15](#step-1️⃣--insert-15)
    - [Step 2️⃣ – Insert 22](#step-2️⃣--insert-22)
    - [Step 3️⃣ – Insert 29](#step-3️⃣--insert-29)
    - [📊 Final Hash Table](#-final-hash-table)
  - [📝 Python Implementation](#-python-implementation-1)
  - [🔎 Code Explanation (line by line)](#-code-explanation-line-by-line)
    - [`get_quadratic(self, key)`](#get_quadraticself-key)
    - [`put_quadratic(self, key, value)`](#put_quadraticself-key-value)
  - [🧪 Test Code](#-test-code-1)
  - [📤 Output](#-output-4)
  - [🌟 Key Insight](#-key-insight)
- [🔐 **Double Hashing in Hash Tables**](#-double-hashing-in-hash-tables)
  - [📖 Introduction](#-introduction)
  - [🖼 Visual Example (Figure 8.10)](#-visual-example-figure-810)
    - [1️⃣ Empty Table](#1️⃣-empty-table)
    - [2️⃣ Insert Element → 15](#2️⃣-insert-element--15)
    - [3️⃣ Insert Element → 22](#3️⃣-insert-element--22)
    - [4️⃣ Insert Element → 29](#4️⃣-insert-element--29)
  - [⚙️ Implementation in Python](#️-implementation-in-python)
    - [🔑 Secondary Hash Function](#-secondary-hash-function)
    - [🏗 HashTable Class (with Double Hashing)](#-hashtable-class-with-double-hashing)
    - [🚀 Insert with Double Hashing](#-insert-with-double-hashing)
    - [🔍 Search with Double Hashing](#-search-with-double-hashing)
    - [🧪 Example Run](#-example-run)
    - [🖨 Output](#-output-5)
  - [📊 Comparison with Other Techniques](#-comparison-with-other-techniques)
- [📚 **Separate Chaining in Hash Tables**](#-separate-chaining-in-hash-tables)
  - [🔑 What is Separate Chaining?](#-what-is-separate-chaining)
  - [📊 Example of Collision Resolution using Chaining](#-example-of-collision-resolution-using-chaining)
  - [🪣 Multiple Elements in a Single Bucket](#-multiple-elements-in-a-single-bucket)
  - [🔎 Searching in Chaining (Linear Search)](#-searching-in-chaining-linear-search)
  - [🌳 Optimizing Chaining with BSTs](#-optimizing-chaining-with-bsts)
  - [⚡ Code Implementation – Separate Chaining](#-code-implementation--separate-chaining)
    - [🧱 Step 1: Node Class](#-step-1-node-class)
    - [🧱 Step 2: Singly Linked List Class](#-step-2-singly-linked-list-class)
    - [🧱 Step 3: Traverse Method](#-step-3-traverse-method)
    - [🧱 Step 4: Search Method](#-step-4-search-method)
    - [🧱 Step 5: Hash Table with Separate Chaining](#-step-5-hash-table-with-separate-chaining)
    - [🧱 Step 6: Hash Function](#-step-6-hash-function)
    - [🧱 Step 7: Insert Method](#-step-7-insert-method)
    - [🧱 Step 8: Get/Search Method](#-step-8-getsearch-method)
    - [🧱 Step 9: Print Hash Table](#-step-9-print-hash-table)
  - [⏱️ Complexity Analysis](#️-complexity-analysis)
- [📘 **Symbol Tables in Compilers \& Interpreters**](#-symbol-tables-in-compilers--interpreters)
  - [🔍 Example in Python](#-example-in-python)
    - [📝 Explanation:](#-explanation-1)
  - [🛠️ Symbols Beyond Variables](#️-symbols-beyond-variables)
  - [📊 Figure 8.15 – Example of a Symbol Table](#-figure-815--example-of-a-symbol-table)
    - [Explanation of the Figure:](#explanation-of-the-figure)
