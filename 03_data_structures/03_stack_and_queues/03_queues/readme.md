...
- [**Queues Data Structure** 🚶‍♂️](#queues-data-structure-️)
  - [� Table of Contents](#-table-of-contents)
  - [�📚 What is a Queue?](#-what-is-a-queue)
  - [🖼️ Figure 5.11: Illustration of a Queue](#️-figure-511-illustration-of-a-queue)
    - [Explanation:](#explanation)
  - [🔄 Queue Operations](#-queue-operations)
    - [Key Rules:](#key-rules)
  - [🏗️ Queue Implementation (Doubly Linked List)](#️-queue-implementation-doubly-linked-list)
  - [🖼️ Figure 5.12: Queue Using a Linked List](#️-figure-512-queue-using-a-linked-list)
    - [Explanation:](#explanation-1)
  - [📝 Table: Queue Operations Example](#-table-queue-operations-example)
  - [⚙️ How Can Queues Be Implemented in Python?](#️-how-can-queues-be-implemented-in-python)
- [**Python List-Based Queues** 📋](#python-list-based-queues-)
  - [🖼️ Figure 5.13: Enqueue Operation on the Queue](#️-figure-513-enqueue-operation-on-the-queue)
    - [Step-by-Step (Enqueue):](#step-by-step-enqueue)
  - [🖼️ Figure 5.14: Dequeue Operation on the Queue](#️-figure-514-dequeue-operation-on-the-queue)
    - [Step-by-Step (Dequeue):](#step-by-step-dequeue)
  - [🐍 ListQueue: A Python List-Based Queue Class](#-listqueue-a-python-list-based-queue-class)
  - [➕ Enqueue Operation](#-enqueue-operation)
    - [Example Usage](#example-usage)
  - [➖ Dequeue Operation](#-dequeue-operation)
    - [Example Usage](#example-usage-1)
  - [⚠️ Limitation](#️-limitation)
- [**Linked List-Based Queues (DLL)** 🔗](#linked-list-based-queues-dll-)
  - [📚 Introduction](#-introduction)
  - [🖼️ Figure 5.15: Enqueuing in an Empty Queue](#️-figure-515-enqueuing-in-an-empty-queue)
  - [🖼️ Figure 5.16: Enqueue Operation (Adding to Rear)](#️-figure-516-enqueue-operation-adding-to-rear)
  - [🖼️ Figure 5.17: Dequeue Operation (Removing from Front)](#️-figure-517-dequeue-operation-removing-from-front)
  - [🏗️ Implementation: Node and Queue Classes](#️-implementation-node-and-queue-classes)
    - [Node Class](#node-class)
    - [Queue Class](#queue-class)
  - [➕ Enqueue Operation (Adding to Rear)](#-enqueue-operation-adding-to-rear)
  - [➖ Dequeue Operation (Removing from Front)](#-dequeue-operation-removing-from-front)
  - [📝 Key points](#-key-points)
- [**Stack-Based Queues** 🔄](#stack-based-queues-)
  - [📚 Introduction](#-introduction-1)
  - [1️⃣ Approach 1: Costly Dequeue Operation](#1️⃣-approach-1-costly-dequeue-operation)
    - [🧩 Enqueue Operation](#-enqueue-operation-1)
      - [🖼️ Figure 5.18: Enqueue Example](#️-figure-518-enqueue-example)
    - [🧩 Dequeue Operation](#-dequeue-operation-1)
      - [🖼️ Figure 5.19: Dequeue Example](#️-figure-519-dequeue-example)
    - [⏱️ Time Complexity](#️-time-complexity)
  - [2️⃣ Approach 2: Costly Enqueue Operation](#2️⃣-approach-2-costly-enqueue-operation)
    - [🧩 Enqueue Operation](#-enqueue-operation-2)
      - [🖼️ Figure 5.20: Enqueue element 23 to empty queue](#️-figure-520-enqueue-element-23-to-empty-queue)
      - [🖼️ Figure 5.21: Enqueue element 13](#️-figure-521-enqueue-element-13)
      - [🖼️ Figure 5.22: Enqueue element 11](#️-figure-522-enqueue-element-11)
    - [🧩 Dequeue Operation](#-dequeue-operation-2)
      - [🖼️ Figure 5.23: Dequeue Example](#️-figure-523-dequeue-example)
    - [⏱️ Time Complexity](#️-time-complexity-1)
  - [🏗️ Python Implementation (Approach 1)](#️-python-implementation-approach-1)
  - [🧑‍💻 Example Usage](#-example-usage)
  - [🖼️ Stack Transfer Demo](#️-stack-transfer-demo)
      - [🖼️ Figure 5.24: Example Stack-1 in a queue](#️-figure-524-example-stack-1-in-a-queue)
      - [🖼️ Figure 5.25: Stack-1 and Stack-2 Transfer](#️-figure-525-stack-1-and-stack-2-transfer)
  - [⚡ Comparison: Linked List vs Stack-Based Queues](#-comparison-linked-list-vs-stack-based-queues)
  - [key points 📝](#key-points-)
