...
- [🌳 Heaps](#-heaps)
  ...
  - [🔼 Max Heap](#-max-heap)
  - [🔽 Min Heap](#-min-heap)
  - [⚡ Importance of Heaps](#-importance-of-heaps)
  - [🌲 Complete Binary Tree](#-complete-binary-tree)
  - [🧮 Heap Implementation using Indexing](#-heap-implementation-using-indexing)
- [🌳 **Insertion Operation**](#-insertion-operation)
  - [📌 Introduction](#-introduction)
  - [🖼️ Step-by-Step Figures](#️-step-by-step-figures)
    - [1️⃣ Insert new node `2` into the heap](#1️⃣-insert-new-node-2-into-the-heap)
    - [2️⃣ Swap nodes `2` and `6`](#2️⃣-swap-nodes-2-and-6)
    - [3️⃣ Swap nodes `2` and `3`](#3️⃣-swap-nodes-2-and-3)
    - [4️⃣ Final Heap](#4️⃣-final-heap)
  - [🔢 Example: Constructing a Heap from Scratch](#-example-constructing-a-heap-from-scratch)
    - [🪜 Steps 1 to 6](#-steps-1-to-6)
    - [🪜 Steps 7 to 9](#-steps-7-to-9)
    - [🪜 Step 10 (Final Insertion)](#-step-10-final-insertion)
  - [🧑‍💻 Implementation in Python](#-implementation-in-python)
    - [⚙️ `arrange()` (Heapify Up)](#️-arrange-heapify-up)
    - [⚙️ `insert()` Method](#️-insert-method)
  - [🏗️ Building the Heap](#️-building-the-heap)
  - [🖨️ Output](#️-output)
  - [✅ Final Observation](#-final-observation)
- [🗑️ **Delete Operation** (Percolate-Down)](#️-delete-operation-percolate-down)
  - [🔍 What is the **Delete** operation?](#-what-is-the-delete-operation)
  - [🪜 Algorithm (Min-Heap) — Step-by-Step](#-algorithm-min-heap--step-by-step)
  - [🖼️ Figures (Full sequence)](#️-figures-full-sequence)
    - [1) Delete the current root (= 2)](#1-delete-the-current-root--2)
    - [2) Move the **last element** (here `6`) to the **root**](#2-move-the-last-element-here-6-to-the-root)
    - [3) Compare root (`6`) with its children (`5` and `3`) → **swap with smaller child `3`**](#3-compare-root-6-with-its-children-5-and-3--swap-with-smaller-child-3)
    - [4) Continue percolating `6` down — here **no swap** with `10`](#4-continue-percolating-6-down--here-no-swap-with-10)
  - [🧑‍💻 Helper \& Core Methods (Python)](#-helper--core-methods-python)
    - [🔎 `minchild(k)` — pick the **smaller** child’s index](#-minchildk--pick-the-smaller-childs-index)
    - [⬇️ `sink(k)` — **percolate down** from index `k`](#️-sinkk--percolate-down-from-index-k)
    - [🗑️ `delete_at_root()` — remove and return the **min (root)**](#️-delete_at_root--remove-and-return-the-min-root)
  - [🧪 Full Example (Insert → Delete Root)](#-full-example-insert--delete-root)
    - [🖨️ Output](#️-output-1)
  - [🧩 Dry-Run of the **Percolate-Down** (matches the printed arrays)](#-dry-run-of-the-percolate-down-matches-the-printed-arrays)
  - [⏱️ Time Complexity](#️-time-complexity)
- [📚 **Deletion of an Element at a Specific Location**](#-deletion-of-an-element-at-a-specific-location)
  - [🖼 Step 1: Deleting Node 3](#-step-1-deleting-node-3)
  - [🖼 Step 2: Comparing and Swapping](#-step-2-comparing-and-swapping)
  - [🖼 Step 3: Final Heap Adjustment](#-step-3-final-heap-adjustment)
  - [⚙️ Implementation in Python](#️-implementation-in-python)
  - [📝 Example Code](#-example-code)
  - [💻 Output](#-output)
- [📚 **Heap Sort Algorithm**](#-heap-sort-algorithm)
  - [⚡ Process of Heap Sort](#-process-of-heap-sort)
  - [🛠️ Maintaining Heap Property](#️-maintaining-heap-property)
  - [💻 Implementation Example](#-implementation-example)
  - [🧹 Sorting Phase](#-sorting-phase)
    - [🔹 Heap Sort Method](#-heap-sort-method)
  - [🚀 Running Heap Sort](#-running-heap-sort)
    - [✅ Output](#-output-1)
